 ...
 *
 */
contract EVToken is StandardToken, SafeMath {
    ...
    function EVToken(address founderInput, address signerInput, uint startBlockInput, uint endBlockInput) {
